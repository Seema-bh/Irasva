...
//           template += '<div class="option quantity-box text-center"><div class="dec button">-</div><input type="text" class="quantity" name="quantity" value="'+cart.items[i].properties.quantity+'"><div class="inc button">+</div></div>';
    ...
    changeQuantityAddToCart: function () {
      ...
      doc.on('click', buttonSlt, function (e) {
        ...
        console.log("cal_custm_price",custom_price,"/",val,"=",cal_custm_price);
        switch (true) {
        ...
        if (self.attr('disabled') !== "disabled") {
          ...
          switch (window.ajax_cart) {
            ...
            case "normal":
              ...
              ella.doAjaxAddToCart(data,var_id, title, image);
              break;
    ...
    doAjaxAddToCartNormal: function (data, title, image) {
      ...
      console.log("jijij",$("#product-add-to-cart").attr("var_id"),"ENGRAVING",$("#compalsury-name").val());
        ...
        qty = $(".qty-group input.custom_val").val();
    ...
    doAjaxAddToCart: function (data, var_id , handle, nojax) {
      var data = {
        quantity: 1,
        id: var_id
      };
